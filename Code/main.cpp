...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    else if(alg_name == "HDIADiverse")
    {
        Piecewise_exhaustion_diveristy_results(pSet, u, k, resultSet, category);
    }
    else if(alg_name == "HDIABound")
    {
        Piecewise_exhaustion_bound_diveristy(pSet, u, k, resultSet, category);
    }

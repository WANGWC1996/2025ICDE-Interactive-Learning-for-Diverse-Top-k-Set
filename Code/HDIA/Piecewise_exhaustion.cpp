        ...
        while(partitionPt.size() > 1)
        {
            ...
            while (curNode->bestpt != NULL && curNode->bestng != NULL) //if it is an internal node
            {
                ...
                if (flag)
                {
                    ...
                    resultSet->printResult_DiversityComparison("HDIA", numOfQuestion, category,
                                                               realResult, u, t1, 0, 0);
                    return;
                }
            }
...
void Piecewise_exhaustion_diveristy_results(point_set *pset, point_t *u, int k, point_set *realResult, std::vector<std::string> &category)
{
    timeval t1;
    gettimeofday(&t1, 0);
    ...
    while(1)
    {
        ...
        while(partitionPt.size() > 1)
        {
            ...
            while (curNode->bestpt != NULL && curNode->bestng != NULL) //if it is an internal node
            {
                ...
                {
                    resultSet = resultSet1;
                    resultSet->printResult_DiversityComparison("HDIA(Diverse)", numOfQuestion, category,
                                                               realResult, u, t1, 0, 0);
                    return;
                }
            }
...
void Piecewise_exhaustion_bound_diveristy(point_set *pset, point_t *u, int k, point_set *realResult, std::vector<std::string> &category)
{
    timeval t1;
    gettimeofday(&t1, 0);
    ...
    while(1)
    {
        ...
        while(partitionPt.size() > 1)
        {
            ...
            while (curNode->bestpt != NULL && curNode->bestng != NULL) //if it is an internal node
            {
                ...
                {
                    resultSet = resultSet1;
                    resultSet->printResult_DiversityComparison("HDIA(Bound)", numOfQuestion, category,
                                                               realResult, u, t1, 0, 0);
                    return;
                }
            }
